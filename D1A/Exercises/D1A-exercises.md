...
4. **Create `BannerModule` — a feature module for the banner:**
   - Create a new file `src/app/banner/banner.module.ts`
   - Import `NgModule` from `@angular/core` and `CommonModule` from `@angular/common`
   - Import `BannerComponent` from `./banner.component`
   - Decorate a class `BannerModule` with `@NgModule`:
...
6. **Create `InfoCardModule` — a feature module for the info card:**
   - Create a new file `src/app/info-card/info-card.module.ts`
   - Same pattern as `BannerModule`: declare `InfoCardComponent`, import `CommonModule`, export `InfoCardComponent`
...
8. **Create `AppModule` — the root NgModule:**
   - Create a new file `src/app/app.module.ts`
   - Import `NgModule` from `@angular/core` and `BrowserModule` from `@angular/platform-browser`
   - Import `AppComponent` from `./app.component`
   - Import `BannerModule` from `./banner/banner.module` and `InfoCardModule` from `./info-card/info-card.module`
   - Decorate a class `AppModule` with `@NgModule`:
...
Below are the complete solution files for each exercise. Files are labeled using the exercise subfolder path.

---

## Exercise 1 Solutions

### Exercise-1-Scaffold-and-Explore/src/main.ts
...
### Exercise-1-Scaffold-and-Explore/src/app/app.config.ts
...
export const appConfig: ApplicationConfig = {
  providers: [
    // Empty for now — providers go here on Days 3–4
  ]
};
```

### Exercise-1-Scaffold-and-Explore/src/app/app.component.ts
...
### Exercise-1-Scaffold-and-Explore/src/index.html
...
<body>
  <!-- Angular renders AppComponent here -->
  <app-root></app-root>
</body>
</html>
```
...
### Exercise-2-Your-First-Component/src/app/greeting/greeting.component.ts
...
### Exercise-2-Your-First-Component/src/app/greeting/greeting.component.html
...
### Exercise-2-Your-First-Component/src/app/greeting/greeting.component.css
...
### Exercise-2-Your-First-Component/src/app/app.component.ts
...
### Exercise-2-Your-First-Component/src/app/app.component.html
...
### Exercise-3-Fix-the-Error/src/app/app.component.ts
...
### Exercise-4-Passing-Data-with-Input/src/app/info-card/info-card.component.ts
...
### Exercise-4-Passing-Data-with-Input/src/app/info-card/info-card.component.html
...
### Exercise-4-Passing-Data-with-Input/src/app/info-card/info-card.component.css
...
### Exercise-4-Passing-Data-with-Input/src/app/app.component.ts
...
### Exercise-4-Passing-Data-with-Input/src/app/app.component.html
...
### Exercise-5-Multiple-Components/src/app/nav-bar/nav-bar.component.ts
...
export class NavBarComponent {
  @Input() siteName: string = 'My Site';
}
```

### Exercise-5-Multiple-Components/src/app/nav-bar/nav-bar.component.html
...
### Exercise-5-Multiple-Components/src/app/nav-bar/nav-bar.component.css
...
.nav-links { font-size: 0.9rem; color: #b0b0b0; }
```

### Exercise-5-Multiple-Components/src/app/hero-section/hero-section.component.ts
...
### Exercise-5-Multiple-Components/src/app/hero-section/hero-section.component.html
...
### Exercise-5-Multiple-Components/src/app/hero-section/hero-section.component.css
...
.hero h1 { font-size: 2.5rem; color: #1a1a2e; margin: 0 0 0.5rem; }
.hero p { font-size: 1.2rem; color: #555; margin: 0; }
```

### Exercise-5-Multiple-Components/src/app/feature-list/feature-list.component.ts
...
export class FeatureListComponent {
  features: string[] = ['Components', 'Data Binding', 'CLI Tools', 'TypeScript'];
}
```

### Exercise-5-Multiple-Components/src/app/feature-list/feature-list.component.html
...
### Exercise-5-Multiple-Components/src/app/feature-list/feature-list.component.css
...
.features h2 { color: #1a1a2e; margin: 0 0 1rem; }
...
### Exercise-5-Multiple-Components/src/app/app.component.ts
...
### Exercise-5-Multiple-Components/src/app/app.component.html
...
### Exercise-6-Scoped-Styles/src/app/alert-box/alert-box.component.ts
...
### Exercise-6-Scoped-Styles/src/app/alert-box/alert-box.component.html
...
### Exercise-6-Scoped-Styles/src/app/alert-box/alert-box.component.css
...
### Exercise-6-Scoped-Styles/src/app/info-box/info-box.component.ts
...
### Exercise-6-Scoped-Styles/src/app/info-box/info-box.component.html
...
### Exercise-6-Scoped-Styles/src/app/info-box/info-box.component.css
...
### Exercise-6-Scoped-Styles/src/app/app.component.ts
...
### Exercise-6-Scoped-Styles/src/app/app.component.html
...
### Exercise-7-ViewEncapsulation/src/app/styled-box/styled-box.component.ts (after fix)
...
### Exercise-8-Team-Roster/src/app/roster-header/roster-header.component.ts
...
### Exercise-8-Team-Roster/src/app/roster-header/roster-header.component.html
...
### Exercise-8-Team-Roster/src/app/roster-header/roster-header.component.css
...
.roster-header h1 { margin: 0; font-size: 1.8rem; }
```

### Exercise-8-Team-Roster/src/app/member-card/member-card.component.ts
...
### Exercise-8-Team-Roster/src/app/member-card/member-card.component.html
...
### Exercise-8-Team-Roster/src/app/member-card/member-card.component.css
...
.member-name { color: #00695c; margin: 0 0 0.25rem; font-size: 1.1rem; }
.member-role { color: #666; margin: 0 0 0.5rem; font-size: 0.9rem; }
.member-dept {
...
### Exercise-8-Team-Roster/src/app/roster-footer/roster-footer.component.ts
...
### Exercise-8-Team-Roster/src/app/roster-footer/roster-footer.component.html

```html
<footer class="roster-footer">
  <p>Total team members: {{ totalMembers }}</p>
</footer>
```

### Exercise-8-Team-Roster/src/app/roster-footer/roster-footer.component.css
...
.roster-footer p { margin: 0; }
```

### Exercise-8-Team-Roster/src/app/app.component.ts
...
### Exercise-8-Team-Roster/src/app/app.component.html
...
### Exercise-8-Team-Roster/src/app/app.component.css
...
### Exercise-9-Legacy-NgModule/src/main.ts
...
### Exercise-9-Legacy-NgModule/src/app/app.module.ts
...
### Exercise-9-Legacy-NgModule/src/app/app.component.ts
...
### Exercise-9-Legacy-NgModule/src/app/banner/banner.component.ts
...
### Exercise-9-Legacy-NgModule/src/app/banner/banner.module.ts
...
### Exercise-9-Legacy-NgModule/src/app/info-card/info-card.component.ts
...
### Exercise-9-Legacy-NgModule/src/app/info-card/info-card.module.ts
