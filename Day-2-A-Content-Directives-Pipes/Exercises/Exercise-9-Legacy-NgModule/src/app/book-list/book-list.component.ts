// book-list.component.ts — Exercise 9: LEGACY component
// Declares the books array and trackById method used in the legacy template.
// Notice: no standalone: true, no imports[] — relies entirely on AppModule.
...
export class BookListComponent {
  ...
  // trackBy function for *ngFor — returns a unique identifier per item.
  // In the modern equivalent, this is replaced by: @for (book of books; track book.id)
