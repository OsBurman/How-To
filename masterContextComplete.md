...
Collect all solutions at the end under # SOLUTIONS. Each solution must include EVERY file in the exercise project — both the files the student changed AND the files that remain unchanged (e.g., main.ts, app.config.ts, index.html, styles.css). Each file as its own labeled code block. The solution folder must be a complete, runnable project so a student can compare or replace their entire exercise folder.
...
All solutions under # SOLUTIONS. Each solution must include EVERY file in the exercise project — both the files the student changed AND the files that remain unchanged (e.g., main.ts, app.config.ts, index.html, styles.css). Each file as its own labeled code block. The solution folder must be a complete, runnable project so a student can compare or replace their entire exercise folder.
